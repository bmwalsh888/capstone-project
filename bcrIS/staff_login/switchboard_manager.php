...
<p id="sw_col3"><b>Manager Resources</b></p>
	...
	<div id="staff3">
		<ul>
			<li><a id="nounderlineRed" href=""><span>DVD Over 15 Days Late</span></a></li>
			<li><a id="nounderline" href="add_DVD.php"><span>Edit DVDs & Movies</span></a></li>
			<li><a id="nounderlineRed" href=""><span>Total Sales by Employee</span></a></li>
			<li><a id="nounderline" href="add_emp.php"><span>Add/Remove Employee</span></a></li>
			<li><a id="nounderlineRed" href=""><span>Monthly Revenue</span></a></li>
			<!--      -->
...
<div>These tools are only visible to manager accounts.<br><br>
		...
		<br><br>NOTE:<br>Only EDIT DVDs & MOVIES<br>and<br>
		ADD/REMOVE EMPLOYEES are included in the prototype
		</div></div>
